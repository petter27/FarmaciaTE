        ...
        <form action="./includes/functions/CRUD_usuario.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select name="usr_tipo" id="ddlTipo" class="form-control">
                    <option value="1" <?php if ($usuario["usr_tipo"] == 1) {
                                            echo 'selected="true"';
                                        } ?>>Admin</option>
                    <option value="2" <?php if ($usuario["usr_tipo"] == 2) {
                                            echo 'selected="true"';
                                        } ?>>Empleado</option>
                </select>
            </div>
            ...
            <div class="col-lg-6 offset-md-3 mr-auto ml-auto">
                <button type="submit" name="editar_usuario" class="btn btn-info btn-block">Editar usuario
                </button>
            </div>
        </form>
